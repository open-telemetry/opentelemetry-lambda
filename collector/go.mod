...
require (
	...
	go.opentelemetry.io/collector/exporter/otlpexporter v0.69.1 // indirect
	go.opentelemetry.io/collector/exporter/otlphttpexporter v0.69.1 // indirect
	...
	go.opentelemetry.io/collector/processor/memorylimiterprocessor v0.69.1 // indirect
