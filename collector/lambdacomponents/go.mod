...
require (
	...
	github.com/open-telemetry/opentelemetry-lambda/collector/processor/coldstartprocessor v0.81.0
	github.com/open-telemetry/opentelemetry-lambda/collector/receiver/telemetryapireceiver v0.81.0
